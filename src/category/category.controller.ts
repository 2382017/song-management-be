// filepath: c:\Users\ASUS\song-management-be\src\genre\category.controller.ts
import {
  Body,
  Controller,
  Delete,
...
export class CategoryController {
  ...
  async create(
    ...
    category.deskripsi = createCategoryDTO.deskripsi;
  ...
  async findAll(
    ...
    const userJwtPayload: JwtPayloadDto = request['user'];
    return await this.categoryService.findByUserId(
      userJwtPayload.sub,
      page,
      limit,
    );
  ...
  async findOne(
    ...
    const userJwtPayload: JwtPayloadDto = request['user'];
    return await this.categoryService.findByUserIdAndCategoryId(
      userJwtPayload.sub,
      id,
    );
  }
